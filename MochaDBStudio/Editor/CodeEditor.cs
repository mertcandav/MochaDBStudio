...
namespace MochaDBStudio.Editor {
    ...
    /// Code Editor.
    /// </summary>
    public partial class CodeEditor:UserControl, ISupportInitialize {
        #region Fields
        ...
        private CodeEditor sourceTextBox;
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            new SolidBrush(Color.FromArgb(CurrentLineColor.A == 255 ? 50 : CurrentLineColor.A,CurrentLineColor))) {
                ...
                for(iLine = startLine; iLine < lines.Count; iLine++) {
                    ...
                    //Mevcut satıra kenarlık çiz
                    if(iLine == Selection.Start.iLine)
                        if(Selection.IsEmpty)
                            e.Graphics.DrawRectangle(new Pen(Color.Gray,2),new Rectangle(textAreaRect.Left,y,textAreaRect.Width,CharHeight));
