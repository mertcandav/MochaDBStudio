...
namespace MochaDBStudio.dialogs {
    /// <summary>
    /// StackItem edit dialog for MochaDB Studio.
    /// </summary>
    public sealed partial class StackItemEdit_Dialog:sform {
        #region Constructors
        ...
        public StackItemEdit_Dialog(MochaDatabase db,string stackName,string path) {
            Database = db;
            SectorName = stackName;
            Path = path;
            Init();
        }
        ...
        private void ValueTB_TextChanged(object sender,EventArgs e) {
            Database.SetStackItemValue(SectorName,valueTB.Text,Path);
        }
        ...
        private void DescriptionTB_TextChanged(object sender,EventArgs e) {
            Database.SetStackItemDescription(SectorName,descriptionTB.Text,Path);
        }
    ...
    // Designer.
    public sealed partial class StackItemEdit_Dialog {
        #region Components
        ...
        public void Init() {
            ...
            valueTB.Placeholder = "Stack item value";
            valueTB.Text = Database.GetStackItemValue(SectorName,Path);
            ...
            descriptionTB.Text = Database.GetStackItemDescription(SectorName,Path);
