...
namespace MochaDBStudio.gui.codesense {
    ...
    public class Item {
        ...
        public Item(string text,int imageIndex) : this(text) {
            this.ImageIndex = imageIndex;
        }

        public Item(string text,int imageIndex,string menuText) : this(text,imageIndex) {
            this.menuText = menuText;
        }

        public Item(string text,int imageIndex,string menuText,string toolTipTitle,string toolTipText) : this(text,imageIndex,menuText) {
        ...
        /// <summary>
        /// Parent MezuaiOtoMenu
        /// </summary>
        public codesense Parent { get; internal set; }
