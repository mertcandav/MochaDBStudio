...
namespace MochaDBStudio.gui.codesense {
    [ToolboxItem(false)]
    public class codesenseListView:UserControl, IAutocompleteListView {
        #region Fields
        ...
        protected override bool ProcessCmdKey(ref Message msg,Keys keyData) {
            var host = Parent as codesenseHost;
            if(host != null)
        ...
        public void ShowToolTip(Item autocompleteItem,Control control = null) {
